...
## 수정한 부분
1. 그래프가 한국어로 잘 보이도록 수정했습니다.
2. CSS와 간단한 디자인들이 조금 수정 되었습니다.
3. hugo-obsidian에서 생성된 json파일들이 자동으로 참고되도록 수정했습니다. (linkmap은 손수 static폴더로 붙여넣기 해주셔야 합니다)


저는 개발을 업으로 하는게 아니라 취미로 배우고 있습니다! 많이 부족해도 웃으며 넘어가주세요.

아래는 원래 기본 테마인 Amethyst의 설명서입니다. Obsidian 이용자를 위해 hugo 옵시디언 테마를 만들어주신 64bitpandas님께 감사의 인사를 드립니다.
